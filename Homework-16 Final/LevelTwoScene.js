    var player;
        ...
        class GameScene extends Phaser.Scene {
            ...
            create() {
                ...
                platforms.create(1000, 300, 'platform1'); // upper right
                platforms.create(150, 400, 'platform2'); // upper left (increased margin from 50 to 150)
                ...
                gem = this.physics.add.sprite(1000, 210, 'gem'); // Create gem sprite on the middle platform
            ...
            createBomb() {
                ...
                newBomb.setVelocity(Phaser.Math.Between(-1000, 1000), 20);
